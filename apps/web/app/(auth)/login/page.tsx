...
const DEV_ACCOUNTS = [
	...
	{ email: "dev@demo.local", password: "DevAccess123!", name: "Bob Developer", role: "Officer" },
	{ email: "manager@demo.local", password: "DevAccess123!", name: "Carol Manager", role: "Chief" },
	{ email: "tester@demo.local", password: "DevAccess123!", name: "Dave Tester", role: "Investigator" },
	{ email: "viewer@demo.local", password: "DevAccess123!", name: "Eve Viewer", role: "Executive" },
]
	...
	return (
		<div className="space-y-6">
			...
			<div className="rounded-xl border bg-muted/40 p-4 space-y-3">
				...
				<p className="text-xs text-muted-foreground text-center">All accounts: <code className="bg-muted px-1 rounded">DevAccess123!</code></p>
			</div>
		</div>
	)
}
